                        ...
                        <section class="section">
                            ...
                            <ul class="list-group z-depth-1">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="dark-grey-text font-small"><i class="fa fa-laptop dark-grey-text mr-2" aria-hidden="true"></i> Nước ép trái cây</a>
                                    <a href=""></a><span class="badge badge-danger badge-pill">43</span></a>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="dark-grey-text font-small"><i class="fa fa-mobile-phone dark-grey-text mr-3" aria-hidden="true"></i>Nước ngọt</a>
                                    <span class="badge badge-danger badge-pill">32</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="dark-grey-text font-small"><i class="fa fa-tablet dark-grey-text mr-3" aria-hidden="true"></i>Đồ ăn vặt</a>
                                    <span class="badge badge-danger badge-pill">18</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="dark-grey-text font-small"><i class="fa fa-tablet dark-grey-text mr-3" aria-hidden="true"></i>Bánh ngọt</a>
                                    <span class="badge badge-danger badge-pill">18</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="dark-grey-text font-small"><i class="fa fa-tablet dark-grey-text mr-3" aria-hidden="true"></i>Bánh mì</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Caffe Sua Da</a></strong></h6>
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="http://haisan14.com/wp-content/uploads/2017/07/cach-lam-nuoc-ep-tao-ngon.jpg" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước ép Táo</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="https://masterpizza.vn/wp-content/uploads/2018/03/D%C6%B0a-h%C3%A2%CC%81u-e%CC%81p.png" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước ép dưa hấu</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="https://7monngonmoingay.net/wp-content/uploads/2015/06/cach-pha-nuoc-chanh-leo-mat-lanh-cho-ngay-he.jpg" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước chanh leo</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước chanh tươi</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="https://cdn.tgdd.vn/Products/Images/2443/76451/nuoc-ngot-coke-sleek-330ml-1-5-700x467.jpg" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước ngọt CoCa-cola</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="http://www.brandsvietnam.com/upload/news/480px/2017/12952_Pepsi.png" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Nước ngọt Pepsi</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex align-items-center">
                                                <!--Card image-->
                                                <div class="view overlay">
                                                    <img src="https://hstatic.net/293/1000092293/1/2016/6-3/1443500471_81592_8936079140014_1_chon_1024x1024.jpg" class="img-fluid" alt="">
                                                    <a>
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-6 pl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Caffe Sữa đá-lon</a></strong></h6>
                                                    <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                                    <!-- Rating -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-12 pt-4">
                            ...
                            <div class="row mt-5 py-2 mb-4 hoverable align-items-center">
                                ...
                                <div class="col-6">
                                    <a><img src="http://media.phunutoday.vn/files/upload_images/2016/01/21/cach-lam-banh-my-trung-ngon-1-phunutoday_vn.jpg" class="img-fluid"></a>
                                </div>
                                <div class="col-6 pl-0">
                                    <!--Card content-->
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-title mb-1"><strong><a href="" class="dark-grey-text">Bánh Mì Trứng</a></strong></h6>
                                        <span class="badge badge-danger mb-2"><strong>1439$</strong></span>
                                        <!-- Rating -->
